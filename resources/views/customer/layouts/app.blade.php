...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0"/>
    ...
    <title>Dashboard  | Emily Dashboard</title>
        ...
        <div class="layout-container">
            ...
            <div class="menu-inner-shadow"></div>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item  {{ request()->routeIs('customer.lead_genrate')? 'active' : '' }}">
                        <a href="{{route('customer.lead_genrate')}}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-tachometer"></i>
                            <div data-i18n="Analytics">Lead Genrate</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item {{ request()->is('profile*') ? 'active' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ request()->is('change_password') ? 'active' : '' }}">
                                <a href="{{route('customer.change_password')}}" class="menu-link">
