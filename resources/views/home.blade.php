            ...
            <div class="row justify-content-center">
                <div class="text-center p-0 mb-2">
                    <div class="card px-0 pb-0 mb-3">
                        ...
                        <form id="msform" method="post" action="{{ route('lead_genrate') }}">
                                @csrf
                            <fieldset>
                                <div class="form-card">
                                    <div class="row">
                                        <div class="col-12">
                                            <h2 class="fs-title">What are your website needs??</h2>
                                        </div>
                                    </div>
                                    <div class="field-main-div">
                                        <div class="field-div">
                                            <input type="radio" id="age1" name="need"
                                                value="To advertise my business/services" required>
                                            <label for="age1">To advertise my business / services</label>
                                        </div>
                                        <div class="field-div">
                                            <input type="radio" id="age2" name="need"
                                                value="To sell products/services e.g. e-commerce">
                                            <label for="age2">To sell products / services e.g. e-commerce</label>
                                        </div>
                                    </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <!-- <input type="button" type="submit" name="next" class="next action-button" id="submit-button"
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-3"> <img src="./assets/images/success.gif" class="fit-image">
                                        </div>
                                    </div> <br><br>
                                    <div class="row justify-content-center">
    ...
    <section class="bg2" data-aos="zoom-in">
        <div class="container-fluid">
            <form id="myForm-search">
                <div class="row">
                    <div class="col-sm-6">
                        <input class="input-form" id="service" type="text"
